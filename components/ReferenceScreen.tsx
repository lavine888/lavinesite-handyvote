...
export function screenHTML(): string {
  return `<div class="reference-screen"><div class="reference-body">
      <aside class="reference-sidebar">
        <img class="reference-avatar" src="/lavine-logo.png" alt="LavineX mark" />
      ...
      <main class="reference-main" id="home">
        ...
        <div class="reference-intro"><img class="reference-avatar reference-inline-avatar" src="/lavine-logo.png" alt="LavineX mark"/><p class="reference-eyebrow">// welcome to my workspace</p><h2>double click to enter articles</h2><p class="reference-name">Lavine Xie <span>— AI Product Builder</span></p><p>Math → Computer Science → AI products.</p><p>I build agent systems, AI-native education, creative technology and quantitative experiments.</p></div>
